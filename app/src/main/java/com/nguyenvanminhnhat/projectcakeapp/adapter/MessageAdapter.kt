...
class MessageAdapter : RecyclerView.Adapter<MessageAdapter.IMessageVH>() {
    ...
    class IMessageVH(view: View)  : RecyclerView.ViewHolder(view){
        fun bind(data : List<MessageModel>, position: Int){
            itemView.apply {
